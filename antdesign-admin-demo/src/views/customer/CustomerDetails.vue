  ...
  <page-header-wrapper :title="false">
    <a-card :bordered="false" title="商户详情">
      <a-descriptions title="商户信息">
        <a-descriptions-item label="商户名称" >{{customer.customerName}}    <a-icon type="form" @click="updateCustomer" /> </a-descriptions-item>
      ...
      <a-descriptions title="管理员信息">
        <a-descriptions-item label="管理员姓名">{{customer.adminName}}    <a-icon type="form" @click="updateAdmin" /></a-descriptions-item>
