            ...
            <el-col :span="24">
                <el-card>
                    ...
                    <el-button-group style="float: left; padding: 0 0;">
                        <el-button size="mini" @click="submitFax" icon="el-icon-s-claim">
                            提交系统计税
                        </el-button>
                        <el-button size="mini" @click="remunerationExport" icon="el-icon-download">
                            劳务报酬导出
                        </el-button>
