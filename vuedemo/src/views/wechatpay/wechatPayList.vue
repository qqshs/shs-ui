            ...
            <el-col :span="24">
                <el-card>
                    <el-scrollbar style="height:100%">
                        ...
                        <el-button-group>
                            <el-button size="mini" @click="checkTax" icon="el-icon-s-claim">提交系统计税</el-button>
                            <el-button size="mini" @click="remunerationExport" icon="el-icon-download">劳务报酬导出</el-button>
                            <el-button size="mini" @click="userInfoExport" icon="el-icon-download">人员信息导出</el-button>
                        </el-button-group>
                        <el-table
                                :data="tableData"
                                height="400"
...
<script>
    export default {
        ...
        methods:{
            ...
            checkTax(){//提交计税
                this.$http.post('/你的URL，base段已经在Main.js中，只需添加目录段', {
                    firstName: 'Fred',
                    lastName: 'Flintstone'
                })
                    .then(function (response) {
